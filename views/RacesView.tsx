...
import { Flag, Plus, Trash2, Play, Square, Share2, MapPin, X, RotateCcw, Loader2, Layers, Link as LinkIcon, CheckCircle2, ChevronRight } from 'lucide-react';
            ...
            <div className="border-t border-slate-50 pt-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {race.checkpoints.map(cp => (
                  <div key={cp.id} className="bg-slate-50 p-5 rounded-2xl border border-slate-100 flex justify-between items-center hover:border-blue-200 transition-colors group">
                    <div>
